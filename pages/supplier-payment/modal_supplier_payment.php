        ...
        <div class="modal-dialog" style="margin-top: 50px;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 15px;">
                    <input type="hidden" id="hidden_id" name="input[sp_id]">
                    ...
                    <div class="form-group row">
                        <div class="col">
                            ...
                            <div>
                                <select class="form-control form-control-sm input-item select2" name="input[supplier_id]" id="supplier_id" onchange="getReference()" required>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <div>
                                <select class="form-control form-control-sm select2 input-item" name="input[payment_type]" id="payment_type" onchange="getPayType()" required>
                    ...
                    <div id="div_check" style="display:none;">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <div>
                                    <select class="form-control form-control-sm input-item pay-check select2" name="input[bank_id]" id="bank_id" required>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <div>
                                <input type="text" class="form-control form-control-sm pay-check input-item" name="input[check_number]" maxlength="30" id="check_number">
                                </div>
                            </div>
                            <div class="col">
        ...
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
                <div class="row" style="font-size: small;">
                    <div class="col-sm-3">
                        <div><b>Supplier:</b> <span id="supplier_label" class="label-item"></span></div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <div><b>Bank:</b> <span id="bank_label" class="label-item"></span></div>
                ...
                <div class="row">
                    <div class="col-4" id="col-item">
                        <form method='POST' id='frm_submit_2'>
                            <input type="hidden" id="hidden_id_2" name="input[sp_id]">
