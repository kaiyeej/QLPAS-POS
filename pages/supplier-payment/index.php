        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Manage spplier payment here</h6>
                </div>
            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <div>
                                ...
                                <div class="btn-group">
                                    <a href="#" class="btn btn-primary btn-sm" onclick="getEntries()">
                                        <span class="text"> Generate</span>
                                    </a>
                                    <a href="#" class="btn btn-success btn-sm" onclick="addModal()">
                                    ...
                                    <a href="#" class="btn btn-danger btn-sm" onclick='deleteEntry()' id='btn_delete'>
...
<script type="text/javascript">
    function getEntries() {
        ...
        var param = "(payment_date >= '"+start_date+"' AND payment_date <= '"+end_date+"') AND branch_id = '"+branch_id+"'";
