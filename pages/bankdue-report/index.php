        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Generate Bank due date report here</h6>
                </div>
            </div>
                            ...
                            <div class="col">
                                ...
                                <div>
                                    <div class="btn-group pull-right">
                                        ...
                                        <button type="button" onclick="exportTableToExcel(this,'dt_entries','Bank-Due-Report')" class="btn btn-success btn-sm btn-icon-split">
                                            <span class="icon">
