        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Manage products here</h6>
                </div>
            </div>
    ...
    function getEntries() {
        ...
        $("#dt_entries").DataTable({
            ...
            "columns": [{
                ...
                {
                    "mRender": function(data, type, row) {
                        return row.product_barcode == '' ? "" : "<center><button class='btn btn-secondary btn-circle btn-sm' onclick=\"openBarcodeModal('" + row.product_barcode + "')\"><span class='ti ti-printer'></span></button></center>";
                    }
                },
                {
