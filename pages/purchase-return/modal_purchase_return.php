<form method='POST' id='frm_submit' class="purchaseReturn">
        ...
        <div class="modal-dialog" style="margin-top: 50px;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 15px;">
                    <input type="hidden" id="hidden_id" name="input[pr_id]">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <label><strong>PO Reference</strong></label>
                            <div>
                                <input type="text" class="form-control form-control-sm input-item" name="input[po_reference_number]" maxlength="30" autocomplete="off" id="po_reference_number" onkeyup="checkPOReference()" required>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
