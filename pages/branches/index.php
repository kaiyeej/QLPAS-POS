        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Manage branches here</h6>
                </div>
            </div>
    ...
    function getEntries() {
        ...
        $("#dt_entries").DataTable({
            ...
            "columns": [{
                ...
                {
                    "mRender": function(data, type, row) {
                        return "<center><button class='btn btn-info btn-circle btn-sm' onclick='getEntryDetails(" + row.branch_id + ")'><span class='ti ti-pencil'></span></button><button class='btn btn-warning btn-circle btn-sm' title='Manage Warehouse' onclick='getWarehouses(" + row.branch_id + ")'><span class='ti ti-location-pin'></span></button></center>";
                    }
                },
                {
                    "data": "branch_name"
