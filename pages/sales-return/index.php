        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0">Manage sales return here</h6>
                </div>
            </div>
...
<script type="text/javascript">
    function getEntries() {
        ...
        var param = "(return_date >= '"+start_date+"' AND return_date <= '"+end_date+"')";
        ...
        $("#dt_entries").DataTable({
            ...
            "columns": [{
                ...
                {
                    "mRender": function(data, type, row) {
                        return "<center><button class='btn btn-primary btn-circle btn-sm' onclick='getEntryDetails2(" + row.sales_return_id + ")'><span class='ti ti-list'></span></button></center>";
                    }
                },
                {
                    "data": "return_date"
    ...
    function getEntries2() {
        ...
        $("#dt_entries_2").DataTable({
            ...
            "columns": [{
                ...
                {
                    "mRender": function(data, type, row) {
                        return "<button type='button' class='btn btn-success btn-circle btn-sm' onclick='addReturn(" + row.return_detail_id + ")'><span class='ti ti-plus'></span></button>";
                    }
                },
            ]
        });
