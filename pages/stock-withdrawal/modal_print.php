     ...
     <div class="modal-dialog  modal-lg" style="margin-top: 50px;" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body" style="padding: 15px;">
                 <input type="hidden" id="hidden_id_withdrawal" name="input[withdrawal_id]">
                 <div class="col-12" id="print_canvas">
                     <center>
                        <strong>
                            ...
                            <h5>Stock Withdrawal</h5>
                         </strong>
                    </center>
                     <strong>Reference Number: </strong><span id="reference_number_span"></span><br>
                     <strong>Date: </strong><span id="withdrawal_date_span"></span><br>
    ...
    function printRecord(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#withdrawal_date_span").html(json.data[0].withdrawal_date);
                $("#remarks_span").html(json.data[0].remarks);

                getPrintDetails(json.data[0].withdrawal_id);
            }
        });
    }
