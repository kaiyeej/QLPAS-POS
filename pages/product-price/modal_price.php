        ...
        <div class="modal-dialog" style="margin-top: 50px;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 15px;">
                    <input type="hidden" id="hidden_id" name="input[price_id]">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            ...
                            <div>
                                <input type="date" class="form-control form-control-sm input-item" name="input[effective_date]" min="<?= date('Y-m-d') ?>" id="effective_date" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-content">
            <div class="modal-header" style="display:block;">
                <div class="row" style="font-size: small;">
                    <div class="col-sm-4">
                        <div><b>Effective Date:</b> <span id="effective_date_label" class="label-item"></span></div>
                        <div><b>Reference:</b> <span id="reference_number_label" class="label-item"></span></div>
                    </div>
                    <div class="col-sm-8">
                        <ul class="nav justify-content-end">
                            <li class="nav-item">
                                <a id="menu-edit-transaction" class="nav-link" href="#" style="font-size: small;"><i class='ti ti-pencil'></i> Edit Price Notice</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-4" id="col-item">
                        <form method='POST' id='frm_submit_2'>
                            <input type="hidden" id="hidden_id_2" name="input[price_id]">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <div>
                                        <input type="number" class="form-control form-control-sm" name="input[old_price]" step=".01" min=0 id="price" readonly required>
                                    </div>
                                </div>
                                <div class="col">
                                    <label><strong>New Price</strong></label>
                                    <div>
                                        <input type="number" class="form-control form-control-sm" name="input[new_price]" step=".01" min=0 required>
                                    </div>
                                </div>
                            </div>
