...
class ClaimSlip extends Connection
{
    ...
    public function show()
    {
        ...
        $result = $this->select("$this->table c LEFT JOIN tbl_sales s ON c.sales_id=s.sales_id LEFT JOIN tbl_customers cu ON s.customer_id=cu.customer_id", "c.*, s.reference_number AS sales_reference_number, s.sales_type, s.customer_id, s.sales_date, s.for_pick_up, cu.customer_name as customer, s.total_sales_amount as total_sales_amount", $param);
