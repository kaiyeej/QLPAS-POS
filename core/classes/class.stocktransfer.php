            ...
            if ($query) {
                ...
                while ($row = $fetch->fetch_assoc()) {
                    $form_inv_in = array(
                        ...
                        'warehouse_id'          => (int) $row['source_warehouse_id'],
                        'product_id'            => (int) $row['product_id'],
                        'quantity'              => floatval($row['qty']),
                        'cost'                  => floatval($row['cost']),
                        'price'                 => 0,
                        'header_id'             => (int) $primary_id,
                        'detail_id'             => (int) $row['stock_transfer_detail_id'],
                        'module'                => 'STK',
                        'type'                  => 'OUT',
                        'status'                => 1,
                    );
                    ...
                    $form_inv_out = array(
                        'branch_id'             => (int) $destination_branch_id,
                        'warehouse_id'          => (int) $row['destination_warehouse_id'],
                        'quantity'              => floatval($row['qty']),
                        'product_id'            => (int) $row['product_id'],
                        'cost'                  => floatval($row['cost']),
                        'price'                 => 0,
